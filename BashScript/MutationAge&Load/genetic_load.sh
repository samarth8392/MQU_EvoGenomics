...
# synonymous (N=210505) and nonsynonymous (N=201311) mutations for each population
...
do
    ...
    do
        ...
        do
            vcftools --vcf /scratch/bell/mathur20/MQU/ch3/revise/vcfs/best66.noSing.auto.nomiss.recode.vcf \
