...
-BQSR ${line[0]}.recal.3.table \
-I ${line[0]}.chick.recal.1.bam \
-o ${line[0]}.chick.recal.2.bam &> log/${line[0]}.2.printreads.log.txt" > /scratch/snyder/m/mathur20/MQU/ch3/jobcodes/mapping/base_recal/${line[0]}_chick_baserecal.sh
...
do
	...
	sbatch  /scratch/snyder/m/mathur20/MQU/ch3/jobcodes/mapping/base_recal/${line[0]}_chick_baserecal.sh
done < /scratch/snyder/m/mathur20/MQU/ch3/reads/best66.samples.list