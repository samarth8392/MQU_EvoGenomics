...
#library(devtools)
#with_libpaths(new = "/scratch/snyder/m/mathur20/MQU/ch3/Rlibs", install_github('tavareshugo/windowscanr'))


library(windowscanr, lib.loc ="/scratch/snyder/m/mathur20/MQU/ch3/Rlibs")
library(vctrs, lib.loc ="/scratch/snyder/m/mathur20/MQU/ch3/Rlibs")
...
write.table(hwe_win, paste0(FILE,".slidingwindows100kb"), row.names=FALSE, quote=FALSE, sep="\t")
