...
-O /scratch/snyder/m/mathur20/MQU/ch3/variants/final_vcfs/mqu.all100.raw.GATK.SNPs.vcf

gatk --java-options "-Xmx100g" VariantFiltration \
-R /scratch/snyder/m/mathur20/MQU/ch3/align/chick/ref/chicken_genome.fa \
-V /scratch/snyder/m/mathur20/MQU/ch3/variants/final_vcf/mqu.all100.raw.GATK.SNPs.vcf \
-O /scratch/snyder/m/mathur20/MQU/ch3/variants/final_vcf/mqu.all100.filterTag.GATK.SNPs.vcf \
--filter-name "QD" \
...
-R /scratch/snyder/m/mathur20/MQU/ch3/align/chick/ref/chicken_genome.fa \
-V /scratch/snyder/m/mathur20/MQU/ch3/variants/final_vcf/mqu.all100.filterTag.GATK.SNPs.vcf \
-O /scratch/snyder/m/mathur20/MQU/ch3/variants/final_vcf/mqu.all100.final.GATK.SNPs.vcf