...
cd /scratch/snyder/m/mathur20/MQU/ch3/mut_age/aztwx/ 
...
for i in `seq 1 1 28` 
do
	vcftools --vcf /scratch/snyder/m/mathur20/MQU/ch3/structure/fineS/run2/input/beagle/best66.noSing.chr$i.beagle.phase.vcf \
	...
	--vcf /scratch/snyder/m/mathur20/MQU/ch3/structure/fineS/run2/input/beagle/best66.noSing.chr$i.beagle.phase.vcf \
	--rec 1e-8 \
